  ...
  return (
    <DropdownMenu>
      ...
      <Dialog open={isConfirmDialogOpen} onOpenChange={setIsConfirmDialogOpen}>
        <DialogContent>
          <DialogTitle className="text-center">¿Estás seguro de que quieres eliminar este alumno?</DialogTitle>          <Button variant={'outline'} onClick={handleDelete}>Sí, eliminar</Button>
