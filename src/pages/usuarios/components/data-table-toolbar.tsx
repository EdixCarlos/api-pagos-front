...
import { DataTableFacetedFilter } from '@/pages/usuarios/components/data-table-faceted-filter.tsx'
import { getSedes } from '@/services/sedeService.ts'
import { AddUsuarioDialog } from '@/pages/usuarios/components/AddUsuarioDialog.tsx'
  ...
  return (
    <div className='flex items-center justify-between'>
      <div className='flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2'>
        ...
        <AddUsuarioDialog isOpen={isOpen} setIsOpen={setIsOpen} />
      </div>
