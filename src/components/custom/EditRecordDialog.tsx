...
export const EditRecordDialog = ({ isOpen, setIsOpen, deuda, formStructure }) => {
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      await updateCarrera(updatedDeuda) // Asegúrate de tener una función para actualizar el registro
      toast.toast({
        variant: 'success',
        title: 'Éxito',
        ...
        <Form {...methods}>
          ...
          <FormField name="estado" render={({ field }) => (
            <>
              ...
              <FormControl>
                <Input {...field} placeholder="Ingresa el estado" />
              </FormControl>
            </>
          )} />
